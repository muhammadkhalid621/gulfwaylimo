...
const ContactInfo = () => {
   const contactInfoData = [
      ...
      },
      {
         ...
         title: 'support@gulfwaylimo.com',
         subtitle: 'info@gulfwaylimo.com'
      },
      {
         id: 3,
               ...
               <div className="row">
                  <div className="col-xxl-12">
                     <div className="page__title-wrapper text-center mb-55">
                        ...
                        <p className='content-description pt-3'>Stay in touch with us</p>
                     </div>
                  </div>
               </div>
               <div className="row">
                     ...
                     contactInfoData.map(info => {
                        return <div key={info.id} className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                           <div className="contact__item text-center white-bg mb-30 transition-3">
                              <div className=" mb-30 d-flex justify-content-center align-items-center">
