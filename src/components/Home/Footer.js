            ...
            <div className="footer__top pt-90 pb-50">
               <div className="container">
                  <div className='row text-center'>
                     <h2 className='text-white mb-20'>Seasoned. Nimble. Remote.</h2>
                     <p className='text-white mb-20'>We’re a diverse and passionate team that takes ownership of your design and empower you to <br/>execute the roadmap. We stay light on our feet and truly enjoy delivering great work.</p>
                  </div>
                  ...
                  <div className="footer__bottom-inner">
                     <div className="row">
                        <div className="col-xxl-6 col-xl-6 col-md-6">
                           ...
                           <img className='footer__w-logo' src="assets/img/logo/logo.png" alt="logo" />
                           </div>
                        </div>
                        <div className="col-xxl-6 col-xl-6 col-md-6">
                           <div className="footer__bottom-link wow fadeInUp text-md-end" data-wow-delay=".8s">
                              ...
                              <div className="footer__social mb-30">
                                 <ul>
                                    <li><a href="#" className="fb"><i className="fab fa-facebook-f text-white"></i></a></li>
                                    <li><a href="#" className="tw"><i className="fab fa-twitter text-white"></i></a></li>
                                    <li><a href="#" className="pin"><i className="fab fa-pinterest-p text-white"></i></a></li>
                                 </ul>
                              </div>
                           </div>
                        </div>
