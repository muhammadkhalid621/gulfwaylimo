               ...
               <div className="row">
                  <div className="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2">
                     <div className="page__title-wrapper text-center mb-55">
                        <h2 className="page__title-2">Create a free Account</h2>
                        ...
                        <div className="sign__form">
                           <form onSubmit={handleSubmit(onSubmit)}>
                              ...
                              <div className="sign__input-wrapper mb-25">
                                 <h5>Email</h5>
                                 <div className="sign__input">
                                    <input {...register("email")} required type="email" placeholder="Email address" />
                              ...
                              <div className="sign__new text-center mt-20">
                                 <p>Already in Gulfway Limo ? <Link href="login"><a > Sign In</a></Link></p>
                              </div>
                           </form>
                        </div>
                     </div>
